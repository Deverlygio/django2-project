...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        products = [
            {'name': 'Broiler Chicken', 'category': 'chicken', 'store': livestock, 'price': 280.00, 'stock': 32},
            {'name': 'Starter Piglet', 'category': 'pig', 'store': livestock, 'price': 620.00, 'stock': 18},
            {'name': 'Pet Dog Food', 'category': 'feeds', 'store': agripet, 'price': 450.00, 'stock': 24},
            {'name': 'Cat Dry Food', 'category': 'feeds', 'store': agripet, 'price': 220.00, 'stock': 29},
            {'name': 'K9 Working Dog', 'category': 'dog', 'store': agripet, 'price': 1200.00, 'stock': 8},
            {'name': 'House Cat', 'category': 'cat', 'store': agripet, 'price': 800.00, 'stock': 10},
        ]
